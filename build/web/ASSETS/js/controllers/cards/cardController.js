function renderCard(data, container){
	...
	userId.hidden = true;
	cardTitle.setAttribute("data-target", "card_show");
	cardTitle.className = "modal-trigger";
	...
	cardTitle.appendChild(document.createTextNode(data.card_name));
	...
	comments.appendChild(document.createTextNode(JSON.stringify(data.comments)));
