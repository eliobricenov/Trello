 ...
 * @author JoseUrdaneta
 */
public class Column_Creation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Column_Creation</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Column_Creation at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int result = db.registerColumn(Integer.parseInt(data.getString("board_id")), 
                    data.getString("column_name"));
                if(result > 0){
                    r.put("status", 200);
                    d.put("column_id", result);
                    d.put("board_id", Integer.parseInt(data.getString("board_id")));
